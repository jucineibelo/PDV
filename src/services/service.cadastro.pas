...
type
  TServiceCadastro = class(TServiceConexao)
    ...
    qryCaixaID_ESTOQUE: TIntegerField;
    qryCaixaID_FORMA_PGTO: TIntegerField;
    qryCaixaDATA_HORA: TSQLTimeStampField;
    qryCaixaTIPO: TStringField;
    qryCaixaVALOR: TFMTBCDField;
    qryCaixaDESCRICAO: TStringField;
    qryReceber: TFDQuery;
    qryReceberItens: TFDQuery;
    qryReceberID: TIntegerField;
    qryReceberID_CLIENTE: TIntegerField;
    qryReceberDOCUMENTO: TStringField;
    qryReceberVALOR: TFMTBCDField;
    qryReceberItensID: TIntegerField;
    qryReceberItensDOCUMENTO: TStringField;
    qryReceberItensDATA: TDateField;
    qryReceberItensVALOR: TFMTBCDField;
    qryReceberItensPARCELA: TStringField;
    qryReceberItensDATA_VENCIMENTO: TDateField;
    qryReceberItensARECEBER: TFMTBCDField;
    qryReceberItensSALDO: TFMTBCDField;
  private
