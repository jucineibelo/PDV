...
begin
  FService := TServiceCadastro.Create(Self); //abrir a conexão no Form create de todos os forms que herdar
end;

procedure TviewBase.FormDestroy(Sender: TObject);
begin
  FService.DisposeOf;  //destruir/fechar conexão ao fechr form
end;
